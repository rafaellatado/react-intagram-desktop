...
export default function Posts() {
  ...
  const postsArr = [{
    ...
    likeImg: 'assets/img/respondeai.svg', likeUserName: 'respondeai', likeNumber:'101.523'
  }, {
    userImg: 'assets/img/barked.svg', userName: 'barked', postImg: 'assets/img/dog.svg', 
    likeImg: 'assets/img/adorable_animals.svg', likeUserName: 'adorable_animals', likeNumber:'87.658'
  }, {
    userImg: 'assets/img/caterpie.png', userName: 'caterpie', postImg: 'assets/img/caterpie-post.jpg', 
    likeImg: 'assets/img/charizard.png', likeUserName: 'charizard', likeNumber:'99.159'
  }]
